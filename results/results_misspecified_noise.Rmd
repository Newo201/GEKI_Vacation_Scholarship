...
```{r}
cor.test(d_in_particles, eta0_particles)
```
...
```{r}
particles <- initialise_malaria_particles_d_in_only(num_particles, prior_params)
plot_eki_prior_predictive_d_in_only(particles, true_data, true_params)
```
