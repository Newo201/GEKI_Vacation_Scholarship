...
plot_eki_normal <- function(eki_result, parameters) {
  ...
  alpha_sequence <- seq(min(alpha_particles), max(alpha_particles), 
                        length.out = 20)
  alpha_prior_density <- dnorm(alpha_sequence, mean = parameters$alpha.mean, 
  ...
  sigma2_sequence <- seq(min(sigma2_particles), max(sigma2_particles),
                         length.out = 20)
  sigma2_prior_density <- dnorm(sigma2_sequence, mean = parameters$sigma2.mean, 
                                sd = parameters$sigma2.sd)
  true_sigma2 <- log(parameters$sigma**2)
...
for (dimension in num_dimensions) {
  ...
  true_parameters <- list(alpha = 2, sigma = 2,
                          x = rep(1, dimension), 
                          alpha.mean = 0, alpha.sd = 5, 
                          sigma2.mean = 5, sigma2.sd = 2)
...
true_parameters <- list(alpha = 2, sigma = 5, 
                        x = rep(1, num_dimensions), 
                        alpha.mean = 0, alpha.sd = 5, 
                        sigma2.mean = 5, sigma2.sd = 2)
