densities_lognormal <- function(true_data, num_particles, particles, parameters) {
...
synthetic_lognormal <- function(num_particles, particles, parameters, mean = F) {
...
initialise_lognormal_particles <- function(num_particles, parameters) {
...
eki_lognormal <- function(num_particles, true_data, true_params, prior_params, adaptive = F) {
  
  initial_particles <- initialise_lognormal_particles(num_particles, prior_params)
  
  if (adaptive) {
    return(eki_adaptive(num_particles, initial_particles, true_data, 
                        true_params, synthetic_lognormal, densities_lognormal))
  }
  else {
    return(eki(num_particles, initial_particles, true_data, 
               true_params, synthetic_lognormal))
  }
